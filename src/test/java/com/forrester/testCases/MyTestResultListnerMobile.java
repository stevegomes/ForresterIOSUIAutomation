...
static int i=2;
	...
	Xls_Reader xlse = new Xls_Reader(System.getProperty("user.dir")+"/src/test/java/com/forrester/xls/TestCasesForrester.xlsx");
...
public void onTestFailure(ITestResult result) 
{
	try
	{
	xlse.setCellData("Test Cases", "Results", i, "Fail");
	Base.takeScreenshot();
	i++;
...
public void onTestSuccess(ITestResult result) {
	...
	try
	{
	xlse.setCellData("Test Cases", "Results", i, "Pass");
	Base.takeScreenshot();
	i++;
	}
	catch(Throwable e)
